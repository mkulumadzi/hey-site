        ...
        <div className="container-fluid">
          <div className="row">
            <div className="centered col-xs-12 col-sm-12 col-md-12">
              ...
              <a href="https://itunes.apple.com/us/app/hey-dance-beats/id1116274610?mt=8"><img className="app-icon hidden-xs hidden-sm" src="assets/hey_logo.png" alt="Slowpost Icon"/></a>
